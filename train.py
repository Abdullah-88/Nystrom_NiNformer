...
logname = "/PATH/Nystrom_NiNformer/Experiments_cifar10/logs_approximator/logs_cifar10.csv"
...
path = "/PATH/Nystrom_NiNformer/Experiments_cifar10/weights_approximator"
